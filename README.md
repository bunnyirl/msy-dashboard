...
How the datasets were integrated:
...
You can predict the variance (surplus/deficit) of each meat type depending on the percentage of the meat that the customers buy.
